            ...
            <div>
               <Swiper navigation>
                    {listing.imageUrls.map((url) => (
                        <SwiperSlide key={url}>
                            <div className='h-[500px]' style={{background: `url(${url}) center no-reapete`}}></div>
                        </SwiperSlide>
                    ))}
               </Swiper>
                ...
                <div className='flex flex-col max-w-4xl mx-auto p-3 my-7 gap-6'>
                    ...
                    <div className='flex gap-4'>
                        ...
                        </p>
                        {
                            ...
                            ${+listing.regularPrice - +listing.discountPrice} Desconto
                        </p>
                    )}
                    </div>
                    ...
                    <ul className='text-green-900 font-semibold text-sm gap-4 sm:gap-6 flex items-center flex-wrap'>
                        ...
                        <li className='flex items-center gap-1 whitespace-nowrap'>
                            ...
                            {listing.bathrooms > 1 ? `${listing.batrooms} baths` : `${listing.bathroom} bath`}
                        </li>
                        <li className='flex items-center gap-1 whitespace-nowrap'>
                        ...
                        <li className='flex items-center gap-1 whitespace-nowrap'>
                            ...
                            {listing.finished ? "Yard Family" : "No Yard Family"}
                        </li>
                    </ul>
